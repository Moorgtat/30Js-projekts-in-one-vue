<template>
    <div id="drum-container">
        ...
        <audio data-key="71" src="../assets/drum/sounds/boom.wav"></audio>
        <audio data-key="72" src="../assets/drum/sounds/ride.wav"></audio>
        <audio data-key="74" src="../assets/drum/sounds/snare.wav"></audio>
        <audio data-key="75" src="../assets/drum/sounds/tom.wav"></audio>
        <audio data-key="76" src="../assets/drum/sounds/tink.wav"></audio>
    </div>
</template>
